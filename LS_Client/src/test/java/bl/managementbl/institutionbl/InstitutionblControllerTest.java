	...
	public void test() {
		...
		try {
			...
			rmsg = institutionblController.insert(new InstitutionVO(
					"025001", "南京市中转中心","02589689341", "南京市秦淮区中山北路63号", 
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"025002", "南京栖霞区营业厅", "02589689342", "南京市栖霞区仙林大道235号",
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"025003", "南京玄武区营业厅", "02589689343", "南京市玄武区汉口路345号",
					""));
			rmsgs.add(rmsg);
			...
			rmsg = institutionblController.insert(new InstitutionVO(
					"021001", "上海市中转中心","02189680211", "上海市秦淮区中山北路63号", 
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"021002", "上海栖霞区营业厅", "02189680212", "上海市栖霞区仙林大道235号",
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"021003", "上海玄武区营业厅", "02189680213", "上海市玄武区汉口路345号",
					""));
			rmsgs.add(rmsg);
			
			
			rmsg = institutionblController.insert(new InstitutionVO(
					"020001", "广州市中转中心","02089680201", "广州市秦淮区中山北路63号", 
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"020002", "广州栖霞区营业厅", "02089680202", "广州市栖霞区仙林大道235号",
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"020003", "广州玄武区营业厅", "02089680203", "广州市玄武区汉口路345号",
					""));
			rmsgs.add(rmsg);
			
			
			rmsg = institutionblController.insert(new InstitutionVO(
					"010001", "北京市中转中心","01089680101", "北京市秦淮区中山北路63号", 
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"010002", "北京栖霞区营业厅", "01089680102", "北京市栖霞区仙林大道235号",
					""));
			rmsgs.add(rmsg);
			rmsg = institutionblController.insert(new InstitutionVO(
					"010003", "北京玄武区营业厅", "01089680103", "北京市玄武区汉口路345号",
					""));
			rmsgs.add(rmsg);
