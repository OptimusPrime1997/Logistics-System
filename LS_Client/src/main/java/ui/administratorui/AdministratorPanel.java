...
public class AdministratorPanel extends javax.swing.JFrame {
	...
	public AdministratorPanel( ArrayList<AccountVO> vos) {
		accountVOs = vos;
		initComponents();
		this.setVisible(true);
	}
																				...
																				.addGroup(
																						layout.createSequentialGroup()
																								...
																								.addPreferredGap(
																										...
																										javax.swing.GroupLayout.DEFAULT_SIZE,
																										Short.MAX_VALUE)
																										.addComponent(account_text).addGap(20)
																										.addComponent(search_btn).addGap(30)
																										.addComponent(add_btn).addGap(30)
																								))))
								.addContainerGap()));
						...
						layout.createSequentialGroup()
								...
								.addGroup(
										layout.createParallelGroup(
												...
												.addComponent(account_text)
												.addComponent(search_btn)
												.addComponent(add_btn))
								.addContainerGap(39, Short.MAX_VALUE)));
	}// </editor-fold>//GEN-END:initComponents
	public AccountBLService getAccountblController() {
		return accountblController;
	}
	public String getOptorName(){
	  ...
	  private void addAccountActionPer(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
	    	UserAccountInfoPanel accountInfo = new UserAccountInfoPanel(this);
	...
	private void search_btnAction(ActionEvent e) {
		 // TODO add your handling code here:
   	boolean found =false;
   	String tofind=account_text.getText();
   	...
   	if(InputCheck.checkAccount(tofind)==ResultMessage.VALID){
   		for (java.util.Iterator<AccountVO> t = vos.iterator(); t.hasNext(); ) {
   			...
   			if(tofind.equals(vo.accountNum)){
   				...
   				accountVOs.add(vo);
   				AccountSearchPanel accountSearchPanel=new AccountSearchPanel(this,accountVOs);
	...
	private javax.swing.JButton add_btn,search_btn;
