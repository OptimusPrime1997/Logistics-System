...
public class UserAccountInfoPanel extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		accountNumjT.addMouseListener(new MouseListener() {
		...
		accountNamejT.addMouseListener(new MouseListener() {
		...
		passwordjT.addMouseListener(new MouseListener() {
		...
		phoneNumjT.addMouseListener(new MouseListener() {
		...
		institutionNumjT.addMouseListener(new MouseListener() {
