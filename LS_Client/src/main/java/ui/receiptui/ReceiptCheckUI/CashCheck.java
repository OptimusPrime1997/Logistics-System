...
public class CashCheck extends javax.swing.JPanel {
    ...
    private void findButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	for(;i<dataVector.size();i++){
    		if(((String)jTable.getValueAt(i, 0)).equals(date))
    			jTable.getCellEditor(i, 0)
    			.getTableCellEditorComponent(jTable, jTable.getValueAt(i, 0), true, i, 0).requestFocus();
    	}
    }
