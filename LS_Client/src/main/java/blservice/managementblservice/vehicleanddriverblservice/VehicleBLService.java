...
public interface VehicleBLService {
	...
	public ArrayList<VehicleVO> showVehicle()throws RemoteException, ClassNotFoundException, IOException;
	public VehicleVO findByVehicleNum(String VehicleNum)throws RemoteException, FileNotFoundException, ClassNotFoundException, NumNotFoundException, IOException;
