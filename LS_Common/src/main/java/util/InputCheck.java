...
public class InputCheck {
	 ...
	 * @param num
	 * @param n
	 * @return num长度为0时返回NOT_COMPLETED; num中有非数字时返回UNVALID_CHAR; num长度不是n时
	 *         返回LENGTH_WRONG; 合法则返回VALID;
	 */
	 ...
	 * 
	 * @param str
	 * @return 没写NOT_COMPLETED; 出现非数字，非小数点UNVALID_CHAR; 合法VALID;
	 */
	 ...
	 * 
	 * @param str
	 * @return 未填写返回NOT_COMPLETED; 填写返回VALID;
	 */
	 ...
	 * 
	 * @param str
	 * @return name长度为0时，返回NOT_COMPLETED; name中出现数字 返回UNVALID_CHAR; name长度大于20
	 *         返回LENGTH_OVER; 合法则返回VALID
	 */
	 ...
	 * 
	 * @param phoneNum
	 * @return phoneNum长度为0时返回NOT_COMPLETED; phoneNum中有非数字时返回UNVALID_CHAR;
	 *         phoneNum长度不是11时 返回LENGTH_WRONG; phoneNum第一个数字不是1 返回WRONG_FORMAT;
	 *         合法则返回VALID
	 */
	 ...
	 * 
	 * @param listNum
	 * @return ListNum长度为0时返回NOT_COMPLETED; ListNum中有非数字时返回UNVALID_CHAR;
	 *         ListNum长度不是10时 返回LENGTH_WRONG; 合法则返回VALID;
	 */
	...
	/**
	 * 检查账号是否合法 输入的账号长度不为11，或有非数字 则返回NOT_FOUND_ACCOUNTNUM; 合法返回VALID;
	 * 
	 * @param accountNum
	 * @return
	 */
	 ...
	 * 
	 * @param str
	 * @return str长度为0时 返回NOT_COMPLETED; str有非数字时 返回UNVALID_CHAR; 合法则返回VALID;
	 */
	...
	public static ResultMessage checkInputDate(String date) {
		if (date != null) {
			...
			return ResultMessage.NULL_DATE;
		}
	}
